 ...
 * Build: http://modernizr.com/download/#-backgroundsize-borderimage-borderradius-boxshadow-flexboxlegacy-opacity-rgba-textshadow-generatedcontent-cssgradients-input-shiv-teststyles-testprop-testallprops-prefixes-domprefixes
 */
window.Modernizr = (function (a, b, c) {
  ...
  function G() {
    e.input = (function (c) {
      ...
      return (
        s.list &&
          (s.list = !!b.createElement("datalist") && !!a.HTMLDataListElement),
        s
      );
    })(
  ...
  !B(x, "undefined") && !B(x.call, "undefined")
    ...
    (q.rgba = function () {
      return (
        z("background-color:rgba(150,255,150,.5)"), C(i.backgroundColor, "rgba")
      );
    }),
